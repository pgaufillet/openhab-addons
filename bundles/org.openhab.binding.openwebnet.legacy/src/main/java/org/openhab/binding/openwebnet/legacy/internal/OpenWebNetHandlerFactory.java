...
import org.openhab.binding.openwebnet.legacy.internal.discovery.OpenWebNetDeviceDiscoveryService;
 ...
 */
@Component(service = ThingHandlerFactory.class, immediate = true, configurationPid = "binding.openwebnet-legacy")
