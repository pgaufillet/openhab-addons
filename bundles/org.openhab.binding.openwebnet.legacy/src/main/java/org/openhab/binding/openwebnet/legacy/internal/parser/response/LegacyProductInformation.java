 ...
 */
@NonNullByDefault
public class LegacyProductInformation extends Response {

    @SuppressWarnings("null")
    private final Logger logger = LoggerFactory.getLogger(LegacyProductInformation.class);

    @Override
    public boolean check(String message) {
        return message.matches("\\*#13\\*[0-9]+#9\\*66\\*[0-9]+##");
    }
